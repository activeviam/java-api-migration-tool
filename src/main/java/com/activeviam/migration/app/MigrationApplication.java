...
public class MigrationApplication {
	 ...
	 *
	 * @param args specifies the path of the project to migrate if length 1, specifies project and current and
	 *        target versions of the library if length 3, specifies project, versions and library name if length 4
	 */
	public static void main(final String[] args) {
		...
		LOGGER.log(
				Level.INFO,
				() -> new StringBuilder("Process migration of ").append(files.size())
						.append(" files in ")
						.append(projectPath)
						.append("...")
						.toString());
