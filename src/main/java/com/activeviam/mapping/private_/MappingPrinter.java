...
public class MappingPrinter {
  ...
  /**
   * The {@link PrintMode mode} used when printing a {@link Mapping} with {@link
   * MappingGenerator#generateMapping(String, String, String)}.
   */
    ...
    if (limit < 0 || mapping.size() <= limit) {
      ...
      LOGGER.log(
          ...
          () -> {
            ...
            mapping.forEach(
                (oldPath, newPath) ->
                    sb.append(MigrationUtils.LINE_SEPARATOR)
                        .append("\t")
                        .append(oldPath)
                        .append(" -> ")
                        .append(newPath));
      ...
      LOGGER.log(
          ...
          () -> {
            final StringBuilder sb =
                new StringBuilder("Mapping=[").append(MigrationUtils.LINE_SEPARATOR);
